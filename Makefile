...
docker:
	docker run --name meshplay-github-io -d --rm -p 4000:4000 -v `pwd`:"/srv/jekyll" jekyll/jekyll:latest bash -c "bundle install; jekyll serve --drafts --livereload"

docker-stop:
	docker stop meshplay-github-io

docker-logs:
	docker logs -f meshplay-github-io
